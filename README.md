...
- **Click any card** to view detailed information about the organism
- In the details panel, click **"Play as [Organism]"** to start the game

### Game Page (game.html)
The game is a rhythm-based survival game where you:

1. **Collect Resources**: Press SPACEBAR or CLICK the moving bar when it's in the green zone
...
5. **Progress Through Difficulty**: All organisms start at EASY and automatically progress to MEDIUM → HARD → EXTREME as your score increases!

### Progressive Difficulty System
- **EASY** (0-99 points): Slower speed, larger hit zone - Perfect for learning!
- **MEDIUM** (100-199 points): Normal speed, medium hit zone - Getting challenging!
- **HARD** (200-299 points): Faster speed, smaller hit zone - Expert level!
- **EXTREME** (300+ points): Lightning fast, tiny hit zone - Can you master it?
...
**Note:** When deployed to a web server (like https://jonathan.michael.ca/), navigation automatically uses clean URLs without showing `index.html` in the address bar.
...
✨ **Responsive Design** - Adaptive card grid (5 cards on desktop, 2 on mobile)
✨ **Dark Theme** - Beautiful dark mode design
✨ **Smooth Animations** - CSS transitions and animations
✨ **Dual Controls** - SPACEBAR or click to play
✨ **Progressive Difficulty** - Automatically increases from Easy to Extreme
